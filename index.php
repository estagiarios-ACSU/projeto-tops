...
<body>
    ...
    <main class="container">
        <div class="content-left">
            ...
            <a href="tops/login.html"><button class="bn632-hover bn18">Login</button></a>
        </div>
...
<svg viewBox="0 0 450 500" xmlns="http://www.w3.org/2000/svg" xmlns:bx="https://boxy-svg.com">
  ...
  <g>
    <a style="" class="top" name="top-1" href="tops/top1.html">
    ...
    <a style="" class="top" name="top-2" href="tops/top2.html">
    ...
    <a style="" class="top" name="top-3" href="tops/top3.html">
    ...
    <a style="" class="top" name="top-4" href="tops/top4.html">
    ...
    <a style="" class="top" name="top-5" href="tops/top5.html">
    ...
    <a style="" class="top" name="top-6" href="tops/top6.html">
    ...
    <a style="" class="top" name="top-7" href="tops/top7.html">
    ...
    <a style="" class="top" name="top-8" href="tops/top8.html">
    ...
    <section class="territorios">
        <div class="top_1">
            <div class="top_1_img">
                <img src="assets/cidade.jpg" alt="">
            </div>
            <div class="top_1_text">
                <h1>Top 1</h1>
                <p>Área Verde, Outra Banda, Parque das Rosas, São Benedito, Pau Serrado...</p>
                <button class="bn632-hover bn18"><a style="color: #fff; text-decoration: none;" href="tops/top1.html">Entrar</a></button>
            </div>
        </div>
        ...
        <div class="top_1">
            ...
            <div class="top_1_text">
                <h1>Top 2</h1>
                <p>Área Seca...</p>
                <button class="bn632-hover bn18"><a style="color: #fff; text-decoration: none;" href="tops/top2.html">Entrar</a></button>
            </div>
        </div>
        ...
        <div class="top_1">
            ...
            <div class="top_1_text">
                ...
                <button class="bn632-hover bn18"><a style="color: #fff; text-decoration: none;" href="tops/top3.html">Entrar</a></button>
            </div>
        </div>
        ...
        <div class="top_1">
            ...
            <div class="top_1_text">
                ...
                <button class="bn632-hover bn18"><a style="color: #fff; text-decoration: none;" href="tops/top4.html">Entrar</a></button>
            </div>
        </div>
        ...
        <div class="top_1">
            ...
            <div class="top_1_text">
                ...
                <button class="bn632-hover bn18"><a style="color: #fff; text-decoration: none;" href="tops/top5.html">Entrar</a></button>
            </div>
        </div>
        ...
        <div class="top_1">
            ...
            <div class="top_1_text">
                ...
                <button class="bn632-hover bn18"><a style="color: #fff; text-decoration: none;" href="tops/top6.html">Entrar</a></button>
            </div>
        </div>
        ...
        <div class="top_1">
            ...
            <div class="top_1_text">
                ...
                <button class="bn632-hover bn18"><a style="color: #fff; text-decoration: none;" href="tops/top7.html">Entrar</a></button>
            </div>
        </div>
        ...
        <div class="top_1">
            ...
            <div class="top_1_text">
                ...
                <button class="bn632-hover bn18"><a style="color: #fff; text-decoration: none;" href="tops/top8.html">Entrar</a></button>
            </div>
        </div>
    </section>
