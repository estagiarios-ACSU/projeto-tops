...
<body>
        ...
        <div class="row">
            <div class="side-menu">
                <ul class="navbar-nav">
                    ...
                    <li class="menu-items" onclick="calendario()">
                        <a href="calendarioR/index.php">Calendário TOP-4</a></li>
            ...
            <div class="content-right">
                ...
                <section class="geral">
                    <div class="content-top">
                      ...
                      <div class="btn-exit">
                        <select class="lista-tops" onchange="location = this.value;">
                            <option value="top4.php">Top 4</option>
                    ...
                    <div class="content-half">
                        <div class="cont-half">
                            ...
                            <span class="top-subtopic">Top-4</span>
                        </div>
                        <div class="cont-half">
                ...
                <section class="calendario">
                    <div class="content-top">
                        <div>
                            <h1 title="Territorios Produtivos">Calendário Top-4</h1>
                            <p>Aldeoma, Novo Parque Iracema, Tangueira, Pato Selvagem, Parque São João, Coité, Parque Iracema, Santos Dumont</p>
                        </div>
                        <div class="btn-exit">
                        <select class="lista-tops" onchange="location = this.value;">
    ...
    <script>
        var map = L.map('map').setView([-3.9055153967603746, -38.681850835719175], 14.3);

        L.tileLayer('https://tile.openstreetmap.org/{z}/{x}/{y}.png?{foo}', { foo: 'bar', attribution: '&copy; <a href="https://www.openstreetmap.org/copyright">OpenStreetMap</a> contributors' }).addTo(map);
        var marker = L.marker([-3.901424172111804, -38.68055524080696]).addTo(map)
        marker.bindPopup("<b>Top-4</b><br>Aldeoma").openPopup();
        ;
        var marker = L.marker([-3.9147114907108316, -38.68974849747284]).addTo(map)
        marker.bindPopup("<b>Top-4</b><br>Novo Parque Iracema").openPopup();
        ;
        var marker = L.marker([-3.8951088636534954, -38.6743779174969]).addTo(map)
        marker.bindPopup("<b>Top-4</b><br>Tangueira").openPopup();
        ;
        var marker = L.marker([-3.9115338913734274, -38.67537639517509]).addTo(map)
        marker.bindPopup("<b>Top-4</b><br>Pato Selvagem").openPopup();
        ;
        var marker = L.marker([-3.899431614011508, -38.67730397240004]).addTo(map)
        marker.bindPopup("<b>Top-4</b><br>Parque São João").openPopup();
        ;var marker = L.marker([-3.9081740875113393, -38.67557182159348]).addTo(map)
        marker.bindPopup("<b>Top-4</b><br>Coité").openPopup();
        ;var marker = L.marker([-3.9054742532440163, -38.681710250081686]).addTo(map)
        marker.bindPopup("<b>Top-4</b><br>Parque Iracema").openPopup();
        ;
        ;var marker = L.marker([-3.905407041634191, -38.68795819417045]).addTo(map)
        marker.bindPopup("<b>Top-4</b><br>Santos Dumont").openPopup();
        ;
