...
<body>
        ...
        <div class="row">
            <div class="side-menu">
                <ul class="navbar-nav">
                    ...
                    <li class="menu-items" onclick="calendario()">
                        <a href="calendarioR/index.php">Calendário TOP-7</a></li>
            ...
            <div class="content-right">
                ...
                <section class="geral">
                    <div class="content-top">
                      ...
                      <div class="btn-exit">
                        <select class="lista-tops" onchange="location = this.value;">
                            <option value="top7.php">Top 7</option>
                    ...
                    <div class="content-half">
                        <div class="cont-half">
                            ...
                            <span class="top-subtopic">Top-7</span>
                        </div>
                        <div class="cont-half">
                ...
                <section class="calendario">
                    <div class="content-top">
                        <div>
                            <h1 title="Territorios Produtivos">Calendário Top-7</h1>
                            <p>Tanques, Cajueiro, Forquilha, Amanari, Retiro, São João do Amanari, Melão, Vassoura, Assentamento Salgado</p>
                        </div>
                        <div class="btn-exit">
                        <select class="lista-tops" onchange="location = this.value;">
    ...
    <script>
        ...
        marker.bindPopup("<b>Top-7</b><br>Tanques").openPopup();
        ;
        var marker = L.marker([-4.052454466390473, -38.82475857966758]).addTo(map)
        marker.bindPopup("<b>Top-7</b><br>Cajueiro").openPopup();
        ;
        var marker = L.marker([-4.034384146702201, -38.789320679065796]).addTo(map)
        marker.bindPopup("<b>Top-7</b><br>Forquilha").openPopup();
        ;
        var marker = L.marker([-4.0228528671949055, -38.86570774789515]).addTo(map)
        marker.bindPopup("<b>Top-7</b><br>Amanari").openPopup();
        ;
        var marker = L.marker([-4.02467862954076, -38.893834674121976]).addTo(map)
        marker.bindPopup("<b>Top-7</b><br>São João do Amanari").openPopup();
        ;var marker = L.marker([-4.0520110564083875, -38.78845602991424]).addTo(map)
        marker.bindPopup("<b>Top-7</b><br>Retiro").openPopup();
        ;var marker = L.marker([-4.06929849790718, -38.81908846523968]).addTo(map)
        marker.bindPopup("<b>Top-7</b><br>Melão").openPopup();
        ;
        ;var marker = L.marker([-4.034569668413943, -38.83032599296127]).addTo(map)
        marker.bindPopup("<b>Top-7</b><br>Vassoura").openPopup();
        ;
        ;
    </script>
</body>
